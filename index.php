        ...
        <div class="container">
            ...
            <div class="row g-0 service-row">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="img/b-alarm.png" alt="Icon">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="img/icon/ic.png" alt="Icon">
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="service-item border h-100 p-5">
                        <div class="btn-square bg-light rounded-circle mb-4" style="width: 64px; height: 64px;">
                            <img class="img-fluid" src="img/icon/networking.png" alt="Icon">
                        </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='img/user1.jpeg' alt=''>">
                    <p class="fs-5">We recently had a CCTV system installed by VIMAL Security System, and we are be happier with the results. The team was professional, knowledgeable, and took the time to understand our needs.</p>
                    <h4>Noodel House</h4>
