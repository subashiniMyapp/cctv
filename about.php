...
<body>
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2">
                            ...
                            As the best CCTV camera installar and service provider in Cuddalore, Vimal CCTV installation and service provides best in class access management solutions that enhance data security, efficiency, and productivity across the corporate network. Our team is young, energetic, and dynamic, committed who believes and practices quality as its profession.
                        </p>
                        <div class="row g-4 mb-4 pb-3">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <h2 class="mb-1" data-toggle="counter-up">27</h2>
    ...
    <!-- About End -->
    <!-- Team Start -->
    <?php include("common/cilents.php"); ?>
    <!-- Team End -->
    <!-- Footer Start -->
